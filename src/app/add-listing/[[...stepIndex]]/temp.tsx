...
const PageAddListing7: FC<PageAddListing7Props> = () => {
  ...
  const uploadFile = async (event: any, index: number) => {
    ...
    const newBoolenArray = [...isImages];
    console.log("newBoolenArray: ", newBoolenArray, index);
    newBoolenArray[index] = true;
    console.log(newBoolenArray);
    setIsImages((prev) => newBoolenArray);
